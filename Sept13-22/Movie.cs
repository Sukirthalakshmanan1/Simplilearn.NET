...
namespace Movieslib
{
    ...
    public class User1 : Movie
    {
       ...
       public void initiate()
        {
            Movie m = new Movie("Don", "tamil", "comedy", 120);
            dbmovies.Add(m);
            Movie k = new Movie("kala", "telugu", "Romance", 300);
            dbmovies.Add(k);
            Movie t = new Movie("lella", "tamil", "Romance", 530);
            dbmovies.Add(t);
            Movie n = new Movie("remo", "Kannada", "Romance", 320);
            dbmovies.Add(n);
